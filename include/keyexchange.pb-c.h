...
/* Generated from: protocol/keyexchange.proto */

#ifndef PROTOBUF_C_protocol_2fkeyexchange_2eproto__INCLUDED
#define PROTOBUF_C_protocol_2fkeyexchange_2eproto__INCLUDED
...
typedef enum _Platform {
  ...
  PLATFORM__PLATFORM_WEBPLAYER = 24,
  PLATFORM__PLATFORM_WP8_ARM = 25,
  PLATFORM__PLATFORM_WP8_X86 = 26,
  PLATFORM__PLATFORM_WINRT_ARM = 27,
  PLATFORM__PLATFORM_WINRT_X86 = 28,
  PLATFORM__PLATFORM_WINRT_X86_64 = 29,
  PLATFORM__PLATFORM_FRONTIER = 30,
  PLATFORM__PLATFORM_AMIGA_PPC = 31,
  PLATFORM__PLATFORM_NANRADIO_NRX901 = 32,
  PLATFORM__PLATFORM_HARMAN_ARM = 33,
  PLATFORM__PLATFORM_SONY_PS3 = 34,
  PLATFORM__PLATFORM_SONY_PS4 = 35,
  PLATFORM__PLATFORM_IPHONE_ARM64 = 36,
  PLATFORM__PLATFORM_RTEMS_PPC = 37,
  PLATFORM__PLATFORM_GENERIC_PARTNER = 38,
  PLATFORM__PLATFORM_WIN32_X86_64 = 39,
  PLATFORM__PLATFORM_WATCHOS = 40
...
#endif  /* PROTOBUF_C_protocol_2fkeyexchange_2eproto__INCLUDED */
